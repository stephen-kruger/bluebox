...
public class MimeMessageParser
{
	...
	private Map<String,DataSource> cidDsMap = new HashMap<String,DataSource>();
	...
	protected void parse(final Multipart parent, final MimePart part)
		...
		else
		{
			...
			else
			{
				...
				{
					DataSource ds;
					this.attachmentList.add(ds = createDataSource(parent, part));
					if (part.getContentID()!=null) 
					{
						cidDsMap.put(part.getContentID(), ds);
					}
				}
			}
		}
	...
	/**
	 * Returns all cids'defined in the body parts of this message.
	 * @return
	 */

...
public class StorageTest extends BaseTestCase {
    ...
    public void testProperties() {
        ...
        assertEquals("Property not correctly set", 143, si.getLongProperty(key));
    }
    ...
    public void testSpool() throws Exception {
        ...
        String uid = si.spoolStream(new ByteArrayInputStream(data.getBytes(StandardCharsets.UTF_8)));
